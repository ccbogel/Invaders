...
"""
Create an output python file called base64_ttf.py
with converted Robotica.ttf into base64
...
class CreateHelperFile:
    ...
    def __init__(self):
        ...
        filename = "base64_ttf.py"
        f = open(filename, 'w', encoding='utf-8-sig')
        f.write(text)
        f.close()
        print("FINISHED CREATING BASE64 TTF HELPER FILE")
